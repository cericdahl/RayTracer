function line_handles = OpticReconCIRTE(geospecs, imagemask, axes_handles, default_maskmode)
...
%% get 2LGeometry
[surface_list rays ray_startingpoints pixels test_pixels] = Create2LGeometry(geospecs);
        ...
        switch default_maskmode
            ...
            case 'small'
                switch c
                    case 1
                        imagemask{c}(:) = -1;
%                         imagemask{c}([1:150 300:end],[240:270 345:375]) = 0;
%                         imagemask{c}(200:350,590:620) = 0;
%                         imagemask{c}(240:250,100:300) = 0;
                        imagemask{c}(200:310,150:270) = 0;
                        imagemask{c}(200:310,350:460) = 0;
                        imagemask{c}(200:310,550:656) = 0;
                    case 2
                        imagemask{c}(:) = -1;
%                         imagemask{c}([1:200 350:end],[250:280 355:385]) = 0;
%                         imagemask{c}(150:300,590:620) = 0;
%                         imagemask{c}(240:250,100:300) = 0;
                        imagemask{c}(200:300,60:90) = 0;
                        imagemask{c}(200:300,250:370) = 0;
                        imagemask{c}(200:300,410:530) = 0;
                        imagemask{c}(200:300,580:656) = 0;
                end
            case 'all'
        end
    end
    ...
    axes(axes_handles(c));
    linehandle = plot(axes_handles(c), xdata, ydata, 'r');
    if ~isempty(linehandle)
        line_handles(c,1) = linehandle;
    end
    hold on;
    ...
    linehandle = plot(axes_handles(c), xdata, ydata, 'b');
    if ~isempty(linehandle)
        line_handles(c,2) = linehandle;
    end
