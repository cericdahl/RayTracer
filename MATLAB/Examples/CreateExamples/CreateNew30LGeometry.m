...
function [surface_list rays ray_startingpoints pixels] = CreateNew30LGeometry()
...
window_inside = -14*2.54 - .254 - 20;
window_thickness = .9*2.54;
chamfer_vertex = -15.81*2.54 - 20;
reflector_bottom = cylinder_bottom-inner_radius-quartz_thickness-5;
...
cam_x = 0;
cam_z = 0;
cam_y = window_inside - window_thickness - 1.5;
cam_focal_length = .8;
% cam_pixel_pitch = .0056265;
cam_ccd_dims = [.00055 .00055] .* [1080 1920];
cam_resolution = [108 192];
