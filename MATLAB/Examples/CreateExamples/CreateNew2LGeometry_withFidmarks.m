...
function [surface_list rays ray_startingpoints pixels] = CreateNew2LGeometry_withFidmarks(geospecs)
...
fid_mark_rphi = 12; % distance around circumference to back points
