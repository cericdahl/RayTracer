...
function [surface_list rays ray_startingpoints pixels] = Create500Geometry(geospecs)
...
% bellows dimensions in cm
largebellows_innerrad = 0; % .5*ID of narrowest point
largebellows_outerrad = 0; % .5*ID of widest point
largebellows_wallthick = 0; % perpendicular wall thickness
largebellows_length = 0; % including sleeves and flanges
largebellows_convolutions = 10; % integer
largebellows_sleevelength = 10; % from convolution to bellows-side of flange
largebellows_flangerad = 10; % .5*OD of flange
largebellows_flangethick = 10;

smallbellows_innerrad = 0;
smallbellows_outerrad = 0;
smallbellows_wallthick = 0;
smallbellows_length = 0;
smallbellows_convolutions = 10;
smallbellows_sleevelength = 10;
smallbellows_flangerad = 10;
smallbellows_flangethick = 10;

bellowsadapter_flangerad = 10;
bellowsadapter_flangethick = 10;
...
pv_cylrad = 8.625*2.54;
pv_wallthick = 0; % applies to cyl and ellipsoids
...
%% derived dimensions
liquid_level = ( (cf3i_mass / cf3i_density) - ((2/3)*pi*(jar_cylrad-jar_cylthick)^2*(jar_axrad-jar_axthick)) ) / ...
