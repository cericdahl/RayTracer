%%%%% IMPORTANT IDEA, DO NOT FORGET THIS!  It would be a good idea to add
%%%%% an offset in the ccd (i.e. center pixel may not be angle zero) as a
%%%%% free paramter (2 paramters).  Although, for a theta lens, that might
%%%%% be exactly the same as pointing the camera differently... is it?
%%%%% I'll work it out.



function GeometryTunerCoupp2L2012()
...
figdata.uihandles.images.datadir = uicontrol(figdata.main, ...
        ...
        'FontUnits','normalized', ...
        'Units','normalized', ...
        'String', '  /data2/storage2/2l-12-data', ...
        'Position',position_scale .* [300 498 110 15], ...
        'HorizontalAlignment','left', ...
        'UserData', '/data2/storage2/2l-12-data', ...
...
%%% 2012 nominal, based on 2009 fit
% geospec_defaults = [ ...
%     1.31, 1.33, 1.458, 1.434, 1.00, 1.52, ...
%     4052, 1.985, ...
%     .55, .55, 0.0, 0.0, ...
...
if figdata.geospecs_changed
    ...
    figdata.display.lines = OpticRecon2L(geospecs, [], figdata.display.axes, figdata.maskmode_list{figdata.mask_ix});
